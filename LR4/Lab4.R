...
df_m <- read.csv("C:/Users/jakep/GitHub/BigData_moment/Lab4/lab4_parus_m.csv", fileEncoding = "Windows-1251", header = TRUE, sep = ";", check.names = F)
df_f<-read.csv("C:/Users/jakep/GitHub/BigData_moment/Lab4/lab4_parus_f.csv", fileEncoding = "Windows-1251", header = TRUE, sep = ";", check.names = F)
